...
def onnx_taint_averagepool(
  ...
  """https://github.com/onnx/onnx/blob/v1.12.0/docs/Operators.md#AveragePool for more details."""

  input_args, taint_input_args = taint_handler.split_args(combined_args, op="averagepool")
...
class TaintAveragePool(averagepool.AveragePool, taint_handler.TaintHandler):

  @classmethod
  def jit_lookup(cls):
    return {averagepool.onnx_averagepool: onnx_taint_averagepool}

  @classmethod
  def data_handler(cls):
    return averagepool.AveragePool
