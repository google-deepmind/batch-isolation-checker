...
def onnx_hardsigmoid(*input_args):
  """https://github.com/onnx/onnx/blob/v1.12.0/docs/Operators.md#HardSigmoid for more details."""
  warnings.warn("This is a placeholder implementation of the HardSigmoid operator. Please replace with a real implementation.")
